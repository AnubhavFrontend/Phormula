                  ...
                  <div className="overflow-x-auto rounded-lg">
                    <table className="min-w-[900px] w-full border-collapse border border-gray-300">
                      ...
                      <tbody>
                        ...
                        {splitInventoryRows.top5.map(
                          (row, index) => (
                            <tr
                              key={`top-${index}`}
                              className="bg-white"
                            >
                              {invDisplayedColumns.map(
                                (col) => (
                                  <td
                                    key={col}
                                    className="px-3 py-2 text-center text-sm text-gray-800 border border-gray-300"
                        ...
                        <tr className="bg-white">
                          ...
                          {invDisplayedColumns
                            ...
                            .map((col) => {
                              const all =
                                splitInventoryRows.top5.concat(
