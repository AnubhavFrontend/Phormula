    ...
    {/* Header: back + logo */}
        <div className="flex items-center justify-between relative">
          <button
            onClick={onClose}
            aria-label="Close"
            className="absolute bottom-5 -left-4 p-2 rounded-full hover:bg-gray-100"
          >
            <img src={ICONS.back} alt="Back" className="w-8 h-8" />
          </button>
        ...
        <h2 id="amazon-connect-title" className="mt-4 text-center text-[26px] font-semibold text-[#5EA68E]">
