      ...
      <div className="flex flex-col flex-1 lg:w-1/2 w-full overflow-y-auto no-scrollbar">
        ...
        <div className="flex flex-col justify-center flex-1 w-full max-w-md mx-auto">
          <div className="rounded-xl border border-gray-200 dark:border-gray-800 p-6 text-center">
            ...
            <h2 className="text-xl font-semibold mb-2 text-gray-800 dark:text-white/90">
          ...
          <div>
            <div className="flex items-center justify-center ">
              <button
                type="button"
                disabled
                className="inline-flex items-center justify-center gap-3 py-3 text-sm font-normal text-gray-700 transition-colors bg-gray-100 rounded-lg px-7 dark:bg-white/5 dark:text-white/90 cursor-not-allowed"
              ...
              {/* <button
                type="button"
                className="inline-flex items-center justify-center gap-3 py-3 text-sm font-normal text-gray-700 transition-colors bg-gray-100 rounded-lg px-7 dark:bg-white/5 dark:text-white/90"
              >
