...
//   // send to dashboard by default; guards will redirect if needed
//   const redirect = search.get("redirect") || "/";

//   const [showPassword, setShowPassword] = useState(false);
//   const [isChecked, setIsChecked] = useState(true); // Keep me logged in
//   const [email, setEmail] = useState("");
//   const [password, setPassword] = useState("");

//   // Prefill from localStorage if available (Remember Me)
//   useEffect(() => {
...
//       login({ email: trimmedEmail, password, rememberMe: isChecked })
//     );

//     if (login.fulfilled.match(res)) {
//       // Prefer a server-side flag if your backend returns it:
//       const user = res.payload.user as any;
//       const serverDone =
//         user?.onboarding_complete === true ||
//         (typeof user?.brand_name === "string" && user.brand_name.trim().length > 0);

//       // Fallback to client flag (first-login in this browser)
//       const localDone =
//         typeof window !== "undefined" &&
//         localStorage.getItem("onboardDone") === "true";

//       if (serverDone || localDone) {
//         router.push(redirect);
//       } else {
//         router.push("/choose-country?onboard=1"); // show onboarding once
//       }
//     }
//   };
...
//           {/* Social row kept, but disabled */}
//           <div className="grid grid-cols-1 gap-3 sm:grid-cols-2 sm:gap-5">
//             <button
//               type="button"
//               disabled
//               className="inline-flex items-center justify-center gap-3 py-3 text-sm font-normal text-gray-700 transition-colors bg-gray-100 rounded-lg px-7 hover:bg-gray-200 hover:text-gray-800 dark:bg-white/5 dark:text-white/90 dark:hover:bg-white/10 cursor-not-allowed"
