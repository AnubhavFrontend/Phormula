...
const CircleChart: React.FC<CircleChartProps> = ({
  ...
  const titleNode = useMemo(() => {
    ...
    return (
      // <>
      //   Expense Breakdown - <span className="text-[#5EA68E]">Year&apos;{y.slice(-2)}</span>
      // </>
      <div className="flex gap-2">
          <PageBreadcrumb pageTitle=" Expense Breakdown - " variant="page" align="left" textSize="2xl" />
          <span className="text-[#5EA68E] text-2xl">
  ...
  return (
    <div className="relative w-full">
      ...
      {/* Chart wrapper
          - Centered
          - Smaller on mobile (max-w-sm), slightly bigger on md (max-w-md), larger on lg
          - Keep aspect square for pie */}
