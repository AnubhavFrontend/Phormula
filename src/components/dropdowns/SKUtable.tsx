...
//             [columnsToDisplay2[3]]: "Net Sales",
//             [columnsToDisplay2[4]]: "Cost of Goods Sold",
//             [columnsToDisplay2[5]]: "Amazon Fees",
//             [columnsToDisplay2[6]]: "Selling Fees",
//             [columnsToDisplay2[7]]: "FBA fees",
//             [columnsToDisplay2[8]]: "Net Credits",
//             [columnsToDisplay2[9]]: "Net Taxes",
//             [columnsToDisplay2[10]]: "CM1 Profit",
//             [columnsToDisplay2[11]]: "CM1 Profit (%)",
//             [columnsToDisplay2[12]]: "CM1 Profit per Unit",
//         };
...
//                                         className="cursor-pointer select-none whitespace-nowrap border border-gray-300 bg-[#4a8773] px-2 py-2 text-center text-[clamp(12px,0.729vw,16px)]"
//                                     >
//                                         <i className={`fa-solid ${showamazonfee ? "fa-caret-right" : "fa-caret-left"}`} />
//                                         &nbsp;Amazon Fees&nbsp;
//                                         <i className={`fa-solid ${showamazonfee ? "fa-caret-left" : "fa-caret-right"}`} />
//                                     </th>
//                                     {showamazonfee && (
//                                         <>
...
//                                         className="cursor-pointer select-none whitespace-nowrap border border-gray-300 bg-[#4a8773] px-2 py-2 text-center text-[clamp(12px,0.729vw,16px)]"
//                                     >
//                                         <i className={`fa-solid ${showprofit ? "fa-caret-right" : "fa-caret-left"}`} />
//                                         &nbsp;CM1 Profit&nbsp;
//                                         <i className={`fa-solid ${showprofit ? "fa-caret-left" : "fa-caret-right"}`} />
//                                     </th>
//                                     {showprofit && (
//                                         <>
//                                             <th className="whitespace-nowrap border border-gray-300 bg-[#4a8773] px-2 py-2 text-center text-[clamp(12px,0.729vw,16px)]">
...
//                 {/* Top & Bottom tables */}
//                 <div className="mt-4 flex flex-col justify-between gap-3 text-[#414042] md:flex-row">
//                     <div className="flex-1">
//                         {/* <h3 className="rounded-md bg-white text-[18px] font-bold text-[#414042]">
//                             Most 5 Profitable Products{" "}
//                             <span className="text-[#5EA68E]">&nbsp;({currencySymbol})</span>
//                         </h3> */}
...
//                                 <thead>
//                                     <tr className="bg-[#5EA68E] font-bold text-[#f8edcf]">
    ...
    return (
        <>
            ...
            <div className={`transition-opacity ${noDataFound ? "opacity-30" : "opacity-100"}`}>
                ...
                {/* (everything below here is unchanged from your original code) */}
                {/* I’ve left it intact for brevity, but you can paste your existing body from here down. */}

                {/* Main table */}
                <div className="w-full overflow-x-auto">
                    <div className="min-w-full">
                        <table className="min-w-[800px] w-full table-auto border-collapse text-[#414042]">
                            {/* ... all your existing thead/tbody rows ... */}
                        </table>
                    </div>
                </div>

                {/* Download button, Top 5 / Bottom 5 tables, modals, etc. (your existing JSX) */}
                {/* ... keep all existing JSX from your original component here ... */}
            </div>
