...
const AppHeader: React.FC = () => {
  ...
  return (
    <>
      <header className="sticky top-0 z-[9999] flex w-full bg-white border-b border-gray-200 dark:border-gray-800 dark:bg-gray-900">
      ...
      {openAmazonFinance && (
        <div className="fixed inset-0 z-[100000] flex items-center justify-center p-4" role="dialog" aria-modal="true">
          ...
          <div className="relative w-full max-w-4xl rounded-xl border border-gray-200 bg-white p-4 shadow-2xl dark:border-gray-800 dark:bg-gray-900">
            <div className="mt-3">
